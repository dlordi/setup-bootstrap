<#
powershell -NoProfile -NoLogo -ExecutionPolicy Bypass -Command "Import-Module .\Set-PowerScheme.psm1; Set-PowerScheme"
#>
...
function Set-PowerScheme {
    param(
        [Parameter()][string] $planName = 'Caffeine'
    )
...
Export-ModuleMember -Function Set-PowerScheme
